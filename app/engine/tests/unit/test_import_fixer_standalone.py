"""
Standalone tests for import fixer that don't require engine imports.
"""
...
# Add tools to path without importing engine
...
class TestDetectMissingImports:
    ...
    def test_detect_missing_imports_parses_any_errors(self) -> None:
        ...
        from tools.import_fixer import detect_missing_imports
...
class TestAddMissingImports:
    ...
    def test_add_missing_imports_to_empty_file(self, temp_file: Path) -> None:
        ...
        from tools.import_fixer import add_missing_imports
