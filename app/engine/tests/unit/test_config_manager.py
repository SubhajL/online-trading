...
class TestMergeConfigSources:
    ...
    def test_config_merge_precedence(self):
        ...
        file_config = {"max_connections": 20, "risk_limit": 0.02}

        env_config = {"max_connections": 30}
    ...
    def test_nested_config_merge(self):
        ...
        overrides = {"database": {"host": "prod.db.example.com", "pool_size": 50}}
