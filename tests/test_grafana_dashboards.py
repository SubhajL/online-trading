...
def test_grafana_dashboards_directory_exists():
    ...
    dashboards_dir = Path(__file__).parent.parent / "infra/grafana/provisioning/dashboards"
...
def test_grafana_dashboards_config_exists():
    ...
    config_path = Path(__file__).parent.parent / "infra/grafana/provisioning/dashboards/dashboards.yml"
...
def test_dashboards_json_directory_exists():
    ...
    assert dashboards_json_dir.exists(), f"Dashboards JSON directory not found at {dashboards_json_dir}"


def test_trading_metrics_dashboard_exists():
    """Verify trading metrics dashboard exists"""
    dashboard_path = Path(__file__).parent.parent / "infra/grafana/dashboards/trading-metrics.json"
    assert dashboard_path.exists(), f"Trading metrics dashboard not found at {dashboard_path}"
...
def test_system_metrics_dashboard_exists():
    ...
    dashboard_path = Path(__file__).parent.parent / "infra/grafana/dashboards/system-metrics.json"
    assert dashboard_path.exists(), f"System metrics dashboard not found at {dashboard_path}"
