...
class DecisionV1(BaseModel):
    ...
    entry_price: float | None = Field(description="Entry price for new positions")
    stop_loss: float | None = Field(description="Stop loss price")
    take_profit: float | None = Field(description="Take profit price")
    position_size: float | None = Field(description="Position size in base currency")
    risk_amount: float | None = Field(description="Risk amount in quote currency")
    risk_percentage: float | None = Field(description="Risk as percentage of capital (0-1)")
    leverage: float | None = Field(description="Leverage to use (1 for spot)")
...
class FeaturesV1(BaseModel):
    ...
    atr: float | None = Field(description="Average True Range")
...
class OrderUpdateV1(BaseModel):
    ...
    price: float | None = Field(description="Order price (null for market orders)")
    stop_price: float | None = Field(description="Stop price (for stop orders)")
    quantity: float = Field(description="Order quantity")
    filled_quantity: float = Field(description="Filled quantity")
    average_fill_price: float | None = Field(description="Average fill price")
...
class SignalsRawV1(BaseModel):
    ...
    take_profit_1: float | None = Field(description="First take profit target")
...
class SmcEventsV1(BaseModel):
    ...
    price_level: float = Field(description="Price at which the event occurred")
    previous_pivot_price: float = Field(description="Price of the previous pivot point")
    previous_pivot_time: str = Field(description="Time of the previous pivot point")
    broken_pivot_price: float = Field(description="Price of the broken pivot point")
...
class ZonesV1(BaseModel):
    ...
    upper_bound: float = Field(description="Upper price boundary of the zone")
    lower_bound: float = Field(description="Lower price boundary of the zone")
